...
// Controller에서 중요한 것은 mapping url. 메서드명 중요치 않음
@Controller
...
public class BoardController {
    ...
    @GetMapping("/create")  // http://localhost:8080/board/crate
    // public String showCreateForm(Model model, HttpSession session) { 에서 SpringSecurity 로 변경
    ...
    public String create(@Valid BoardForm boardForm, BindingResult bindingResult,
        ...
        boardForm.setWriterId(loginUser.getLoginId());
        // #PRC06 - 입력값이 정확하면 서비스에 메서드 호출. 파라미터로 폼값을 받음
    ...
    public String edit(@PathVariable("boardId") Long boardId,
        ...
        return "redirect:/board/detail/" + boardId;  // 수정된 자신의 글 상세로 이동
    }
